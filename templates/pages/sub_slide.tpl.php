<div class="row">	
			<div id="fullwidth_slider" class="everslider fullwidth-slider es-slides-ready es-swipe-grab">  
				<ul class="es-slides">  
						<li>
					...
					<div class="es-ticker"><a href="#" class="es-play" style="display: block;"><span>Play</span></a><a href="#" class="es-pause" style="display: none;"><span>Pause</span></a></div>
					<div class="es-navigation">
						<a href="" class="es-prev"><span class="alt-arrow">Next</span></a>
						<a href="" class="es-next"><span class="alt-arrow">Next</span></a>
					</div>
			</div>
</div>
